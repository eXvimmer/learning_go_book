...
import (
	...
	"github.com/exvimmer/context_values/identity"
	"github.com/exvimmer/context_values/tracker"
...
func (bl BusinessLogic) businessLogic(ctx context.Context, user, data string) (string, error) {
